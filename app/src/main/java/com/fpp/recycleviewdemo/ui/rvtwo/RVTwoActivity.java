...
import com.fpp.recycleviewdemo.base.ui.BaseActivity;
import com.fpp.recycleviewdemo.bean.Status;
import com.fpp.recycleviewdemo.data.DataServer;
 ...
 * @Author fpp
 * @Date 2019/1/6 0006 23:54
 */
public class RVTwoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rv_two);
...
//        mAdapter.setPreLoadNumber(3);
        ...
        mRecyclerView.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(final BaseQuickAdapter adapter, final View view, final int position) {
                Toast.makeText(RVTwoActivity.this, Integer.toString(position), Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void addHeadView() {
        ...
        headView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mRecyclerView.setAdapter(mAdapter);
                Toast.makeText(RVTwoActivity.this, "change complete", Toast.LENGTH_LONG).show();
    ...
    private void refresh() {
        ...
        new Request(mNextRequestPage, new RequestCallBack() {
            ...
            public void fail(Exception e) {
                Toast.makeText(RVTwoActivity.this, R.string.network_err, Toast.LENGTH_LONG).show();
                mAdapter.setEnableLoadMore(true);
                mSwipeRefreshLayout.setRefreshing(false);
            }
        }).start();
