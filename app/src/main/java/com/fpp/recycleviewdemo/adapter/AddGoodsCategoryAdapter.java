package com.fpp.recycleviewdemo.adapter;
...
import com.fpp.recycleviewdemo.bean.GoodsCategory;
import com.fpp.recycleviewdemo.bean.GoodsItem;
import com.fpp.recycleviewdemo.recycleview.LVOrRCVActivity;
import com.fpp.recycleviewdemo.utils.LogUtils;
import com.fpp.recycleviewdemo.utils.ToastUtils;
        ...
        extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 初始化布局管理器
        mLayoutManager = new LinearLayoutManager(mAddServiceOrCommodityActivity, LinearLayoutManager.HORIZONTAL, false);
        // 初始化适配器
        final AddGoodsItemAdapter addGoodsItemAdapter = new AddGoodsItemAdapter(mAddServiceOrCommodityActivity, goodsItemList);

        // 设置布局管理器
        holder.hlvFragmentAddService.setLayoutManager(mLayoutManager);
        // 设置adapter
        holder.hlvFragmentAddService.setAdapter(addGoodsItemAdapter);
        // 设置Item之间间隔样式
//        holder.hlvFragmentAddService.addItemDecoration(new MyDividerItemDecoration(mAddServiceOrCommodityActivity, LinearLayoutManager.HORIZONTAL));
        ...
        addGoodsItemAdapter.setOnItemDeleteClickListener(new AddGoodsItemAdapter.OnItemDeleteListener() {
            ...
            public void onDeleteClick(int position, AddGoodsItemAdapter.ViewHolder holder) {
                ...
                LogUtils.e("delete -- position = " + position + "    holder = " + holder);
...
//                }
        ...
        addGoodsItemAdapter.setOnItemAddClickListener(new AddGoodsItemAdapter.OnItemAddListener() {
            ...
            public void onAddClick(int position, AddGoodsItemAdapter.ViewHolder holder) {
                GoodsItem item = addGoodsItemAdapter.getItem(position);
                LogUtils.e("acuid = " + item.getAcuid());
                LogUtils.e("add -- position = " + position + "    holder = " + holder  + "   add = "+ addGoodsItemAdapter.getItemId(position));
