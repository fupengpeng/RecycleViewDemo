...
public class RVAdapter extends RecyclerView.Adapter<RVAdapter.Holder> {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (show) {
            ...
            view = LayoutInflater.from(context).inflate(R.layout.all_products_one_lines, parent, false);
            Holder holder = new Holder(view);
            return holder;
        } else {
            Log.e("-------show----------", "" + show);
            view = LayoutInflater.from(context).inflate(R.layout.all_products_two_lines, parent, false);
            Holder holder = new Holder(view);
            Log.e("-------------------------------------", "++++++++++++++++++++++++++++++++++++");
            return holder;
        }
