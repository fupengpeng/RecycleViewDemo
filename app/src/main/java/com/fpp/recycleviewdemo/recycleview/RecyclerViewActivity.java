...
//        recyclerview04.setLayoutManager(new StaggeredGridLayoutManager(4, StaggeredGridLayoutManager.VERTICAL));
    ...
    private void initView03() {
        recyclerview03.setLayoutManager(new GridLayoutManager(this, 3));
...
//        startActivity(intent);
    ...
    @OnClick({R.id.rv1, R.id.rv2, R.id.rv3, R.id.rv4, R.id.rv5, R.id.rv6, R.id.rv7})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.rv1:

                recyclerview01.setVisibility(View.VISIBLE);
                recyclerview02.setVisibility(View.GONE);
                recyclerview03.setVisibility(View.GONE);
                recyclerview04.setVisibility(View.GONE);
                recyclerview05.setVisibility(View.GONE);
                recyclerview06.setVisibility(View.GONE);
                recyclerview07.setVisibility(View.GONE);


                break;
            case R.id.rv2:
                recyclerview01.setVisibility(View.GONE);
                recyclerview02.setVisibility(View.VISIBLE);
                recyclerview03.setVisibility(View.GONE);
                recyclerview04.setVisibility(View.GONE);
                recyclerview05.setVisibility(View.GONE);
                recyclerview06.setVisibility(View.GONE);
            ...
            case R.id.rv3:
                recyclerview01.setVisibility(View.GONE);
                recyclerview02.setVisibility(View.GONE);
                recyclerview03.setVisibility(View.VISIBLE);
                recyclerview04.setVisibility(View.GONE);
                recyclerview05.setVisibility(View.GONE);
                recyclerview06.setVisibility(View.GONE);
                recyclerview07.setVisibility(View.GONE);
            ...
            case R.id.rv4:
                ...
                recyclerview02.setVisibility(View.GONE);
                recyclerview03.setVisibility(View.GONE);
                recyclerview04.setVisibility(View.VISIBLE);
                recyclerview05.setVisibility(View.GONE);
                recyclerview06.setVisibility(View.GONE);
                recyclerview07.setVisibility(View.GONE);
                break;
            case R.id.rv5:
                ...
                recyclerview03.setVisibility(View.GONE);
                recyclerview04.setVisibility(View.GONE);
                recyclerview05.setVisibility(View.VISIBLE);
                recyclerview06.setVisibility(View.GONE);
                recyclerview07.setVisibility(View.GONE);
                break;
            case R.id.rv6:
                ...
                recyclerview04.setVisibility(View.GONE);
                recyclerview05.setVisibility(View.GONE);
                recyclerview06.setVisibility(View.VISIBLE);
                recyclerview07.setVisibility(View.GONE);
                break;
            case R.id.rv7:
                recyclerview01.setVisibility(View.GONE);
                ...
                recyclerview05.setVisibility(View.GONE);
                recyclerview06.setVisibility(View.GONE);
                recyclerview07.setVisibility(View.VISIBLE);
                break;
        }
    }
